...
$.fn.autocompletehtml = function () {
    ...
    var autoComplete = this.data("ui-autocomplete") || this.data("autocomplete");
    autoComplete._renderItem = function _renderItemHTML(ul, item) {
        ...
        // Below highlights matching substring, from http://stackoverflow.com/a/3457773/416687
        // does slow down performance somewhat
